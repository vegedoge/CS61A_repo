...
def pingpong(n):
    ...
    """
    "*** YOUR CODE HERE ***"
    def increment_helper(n):
        if n == 0:
            return 0
        elif num_eights(n) != 0 or n % 8 == 0:
            return 1 + increment_helper(n-1)
        else:
            return increment_helper(n-1)
        
    if n == 0:
        return 0
    elif increment_helper(n-1) % 2 == 0: 
...
def missing_digits(n):
    ...
    """
    "*** YOUR CODE HERE ***"
    last_2_digit = (n % 100 - n % 10) // 10
    last_1_digit = n % 10
    last_2_gap = last_1_digit - last_2_digit
    if n < 10:
        return 0
    elif last_2_gap > 1:
        return missing_digits(n // 10) + last_2_gap - 1
    else:
