...
'''
Tutorial: Recall the hailstone function from Homework 1. First, pick
...
def merge(n1, n2):
    ...
    if n1 == 0:
        ...
        return 10 * merge(n1, n2 // 10) + n2_last
    else:  # condition = and < can be the same
        return 10 * merge(n1 // 10, n2) + n1_last
